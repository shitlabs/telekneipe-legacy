...
(function (root, factory) {
	...
	*/
	...
	requestAnimationFramePassive = (function (){
		var lastTime = 0;
	...
	requestAnimationFrameActive = (function (){
		var lastTime = 0;
	...
	cancelAnimFramePassive = (function (){
	...
	cancelAnimFrameActive = (function (){
		return  window.cancelAnimationFrame ||
				window.webkitCancelAnimationFrame ||
				window.mozCancelAnimationFrame ||
				window.oCancelAnimationFrame ||
	...
	*/
	...
	function Seriously(options) {
		...
		// hack: check if process should run timer based or based on requestAnimationFrame
		var requestAnimationFrame = (options["active"] ? requestAnimationFrameActive : requestAnimationFramePassive);
		var cancelAnimationFrame = (options["avtive"] ? cancelAnimFrameActive : cancelAnimFramePassive);
